...
export class AddRelations1729649059988 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."answer_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."lesson_course_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_lesson_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."lesson_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."question_lesson_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_question_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."question_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."course_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_course_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."invoice_status_enum" AS ENUM('ACTIVE', 'IN_ACTIVE')`);
